...
namespace Cat
{
    public class Cat : IServiceProvider, IDisposable
    {
        ...
        private readonly ConcurrentDictionary<Key, object> _services; // non transient
        private readonly ConcurrentBag<IDisposable> _disposables; // transient and self service 
